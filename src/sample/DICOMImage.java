...
public class DICOMImage implements Comparable < DICOMImage >
{
    ...
    double
            SliceLocation;
    int
            SeriesNumber, AcquNumber, InstNumber;
    double
            AcquTime, ContTime, TrigTime;
...
//******************************************************************************
    ...
    {
        InputStream
                fis = (new URL(PathName + "/" + FileName)).openStream();
...
// initial datatype assuming explicit
        ...
        for ( ; ; )
        {
            ...
            if ( tag2[0] == 0x0002 && tag2[1] == 0x0001 )
            // version
            {
                short
                        vers;
            ...
            if ( tag2[0] == 0x0008 && (tag2[1] == 0x1110 || tag2[1] == 0x1111 || tag2[1] == 0x1115 || tag2[1] == 0x1120) )
            ...
            if ( tag2[0] == 0x0028 && (tag2[1] == 0x0010 || tag2[1] == 0x0011) )
            // width || height
            {
                byte
                        ch [ ] = new byte [ len4 ];
            ...
            if ( tag2[0] == 0x7FE0 && tag2[1] == 0x0010 )
            // pixel data
            {
            ...
            if ( dt.equals("OB") || dt.equals("FL") || dt.equals("FD") || dt.equals("SS") || dt.equals("US") || len4 > 0 )
            ...
            if ( tag2[0] == 0x0020 && (tag2[1] == 0x0011 || tag2[1] == 0x0012 || tag2[1] == 0x0013 || tag2[1] == 0x1041) )
    ...
    @Override
    public int compareTo(DICOMImage dicomImage)
    {
        if((int)(dicomImage.SliceLocation - SliceLocation) != 0)
        {
            return (int)(dicomImage.SliceLocation - SliceLocation);
        }
        if(dicomImage.SeriesNumber - SeriesNumber != 0)
        {
            return dicomImage.SeriesNumber - SeriesNumber;
        }
        return dicomImage.InstNumber - InstNumber;
    }
}
